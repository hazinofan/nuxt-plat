  ...
  <section class="py-24 bg-gray-100">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mb-12 text-center">
        ...
        <p class="text-gray-500 leading-6 mb-9">
          basé les 100 derniers commandes
        </p>

        <!-- PrimeVue InputSwitch -->
        <div class="flex justify-center items-center gap-4">
          <span class="text-lg font-medium text-gray-700">Single</span>
          <InputSwitch v-model="isDouble" />
      ...
      >
        ...
        >
          ...
          <h3 class="font-manrope text-2xl font-bold mb-4 text-gray-900">
            {{ plan.name }}
          </h3>
          ...
          <div class="mb-6">
            ...
            >
            <span
              class="text-xl text-gray-400 line-through ml-2"
