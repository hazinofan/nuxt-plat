...
<template>
  <NuxtLayout name="support">
    ...
    >
      ...
      <div v-else>
        <NuxtLink to="/" class=" text-purple-500 flex flex-row gap-5 items-center hover:text-purple-800 transition-colors hover:underline mb-7">
          <i className="pi pi-arrow-left"></i>
          Retourner a la page des Blogs
        </NuxtLink>
